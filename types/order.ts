...
export interface IgetNodoorsOfficesByCityFx {
  city: string
  lang: string
}

export interface INodoorsAddressData {
...
export interface IPickupAddressItemProps {
  addressItem: INodoorsAddressData
  handleSelectAddress: (arg0: IAddressBBox, arg1: IAddressPosition) => void
  handleChosenAddressData: (arg0: Partial<INodoorsAddressData>) => void
}
